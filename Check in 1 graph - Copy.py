...
filename="C:\\Users\\LENOVO\\Dropbox\\School\\PHY180- Classical Mechanics\project\\Check in 2 graph.txt"
""" 
...
########### HERE!!! ##############
    ...
    ax1.plot(xs, curve, label="Period-Angle graph", color="black")
    ...
    ax1.set_title("Period-Angle graph")
